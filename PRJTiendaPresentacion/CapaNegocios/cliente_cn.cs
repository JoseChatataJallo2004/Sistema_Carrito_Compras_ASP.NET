    ...
    public class cliente_cn
    {
        ...
        public bool reestablecerclave(int idcliente, string correo, out string mensaje)
        {
            ...
            if (resultado)
            {
                ...
                string mensaje_correo = "<h3> Hola te habla el Ing. de Sistemas Jose Manuel   Su cuenta fue reestablecida correctamente </h3></br><p>Su contraseña para acceder ahora es : !clave!</p>";
